 ...
 * packaging it as a Web Worker. The use of this Linker requires that the module
 * have exactly one distinct compilation result. If it does not, a (hopefully
 * useful) list of properties that would cause multiple compilation results will
 * be logged.
 * 
 * @see <a href='http://www.whatwg.org/specs/web-workers/current-work/'>Web
 *      Worker Draft Spec</a>
 */
...
public class WorkerModuleLinker extends SelectionScriptLinker {
    ...
    protected Collection<Artifact<?>> doEmitCompilation(TreeLogger logger,
            ...
            ArtifactSet artifactSet) throws UnableToCompleteException {
        ...
        return super.doEmitCompilation(logger, context, result, artifactSet);
    }

    // @Override
    // protected Collection<EmittedArtifact> doEmitCompilation(TreeLogger
    // logger,
    // LinkerContext context, CompilationResult result)
    ...
    protected EmittedArtifact emitSelectionScript(TreeLogger logger,
        ...
        /*
         * Point $wnd and $doc to insideWorker global scope. Shouldn't be used,
         * but there in case preexisting code uses either as a generic global
         * variable normal access of $wnd and $doc attributes and methods will
         * be broken, per Worker spec
         */
        ...
        out.print("var $moduleName, $moduleBase;"); // needed if no stats/error
                                                    // handling?
        out.newlineOpt();
