...
public class WorkerGlobalScopeImplNative implements WorkerGlobalScope {
     ...
     * 
     * @see
     * gwt.ns.webworker.client.WorkerGlobalScope#importScript(java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * gwt.ns.webworker.client.WorkerGlobalScope#importScripts(com.google.gwt
     ...
     * 
     * @see
     * gwt.ns.webworker.client.WorkerGlobalScope#importScripts(java.lang.String
     * [])
     */
     ...
     * 
     * @see
     * gwt.ns.webworker.client.WorkerGlobalScope#postMessage(java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * gwt.ns.webworker.client.WorkerGlobalScope#setErrorHandler(gwt.ns.webworker
     * .client.ErrorHandler)
     */
    // Note: no UncaughtExceptionHandler since this code will never run in dev
    // mode
    @Override
     ...
     * 
     * @see
     * gwt.ns.webworker.client.WorkerGlobalScope#setMessageHandler(gwt.ns.webworker
