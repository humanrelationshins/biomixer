	...
	public String generate(TreeLogger logger, GeneratorContext context,
		...
		if (out != null) {
			...
			if (entryPoints.length < 1) {
				logger.log(TreeLogger.ERROR, "Worker defined in " + moduleName + " must have an entry point specified.");
				throw new UnableToCompleteException();
			} else if (entryPoints.length > 1) {
				logger.log(TreeLogger.ERROR, "Only a single entry point is currently supported. " + moduleName + " appears to define more than one:");
